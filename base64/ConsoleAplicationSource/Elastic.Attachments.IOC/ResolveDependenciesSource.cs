// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ResolveDependenciesSource.cs" company="Elastic.Attachments">
//   Elastic.Attachments
// </copyright>
// <summary>
...
namespace Elastic.Attachments.IOC
{
    ...
    public class ResolveDependenciesSource : IRegistrationSource
    {
        ...
        public IEnumerable<IComponentRegistration> RegistrationsFor(Service service, Func<Service, IEnumerable<IComponentRegistration>> registrationAccessor)
        {
            ...
            {
                var classType = Enumerable.FirstOrDefault<Type>(ts.ServiceType.Assembly.GetTypes(), t => ts.ServiceType.IsAssignableFrom(t) && t.IsClass);
                if (classType != null)
                {
